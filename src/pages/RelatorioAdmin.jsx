...
import DataHealthCard from "@/components/relatorioAdmin/DataHealthCard";
...
export default function RelatorioAdmin() {
    ...
    const { dataHealth, teamStructure, loading, error } = useAdminData();
    ...
    return (
        <div className="p-4 md:p-8 bg-gray-50 min-h-screen" role="main">
